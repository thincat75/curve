...
CSErrorCode CSDataStore::FlattenChunk (ChunkID id, SequenceNum sn,
    ...
    std::cout << "CSDataStore::FlattenChunk " << "id = " << id << std::endl;
    ...
    errorCode = chunkFile->flattenWrite(sn, cloneCtx, *this);
    if ((errorCode != CSErrorCode::Success) && (errorCode != CSErrorCode::FlattenAgain)){
